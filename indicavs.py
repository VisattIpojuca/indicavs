...
COLUNA_MAP = {
    'SEMANA_EPIDEMIOLOGICA_2': 'SEMANA_EPIDEMIOLOGICA', # Nome limpo
    'DATA_DE_NOTIFICACAO': 'DATA_NOTIFICACAO',
    'DATA_PRIMEIRO_SINTOMAS': 'DATA_SINTOMAS',
    'FA': 'FAIXA_ETARIA', 
    'BAIRRO_RESIDENCIA': 'BAIRRO',
    'EVOLUCAO_DO_CASO': 'EVOLUCAO', # Nome limpo
    'CLASSIFICACAO': 'CLASSIFICACAO_FINAL', # Nome limpo, corrigindo o mapeamento (CLASSIFICAÇÃO -> CLASSIFICACAO_FINAL)
    'RACA_COR': 'RACA_COR',
